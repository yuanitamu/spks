      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              <div>
                <a href="#bid" class="btn btn-lg btn-info center" data-toggle="modal" style="margin-top:5px ; margin-bottom:5px">Penawaran</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="modal-body">
            <?php echo form_open_multipart("pelelangan_controller/tawar"); ?>
            <div class="controls">
