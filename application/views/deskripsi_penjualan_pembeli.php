    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="row">
            <div>
              <a href="<?php echo base_url();?>penjualan_controller/beli/<?php echo $key->id_barang?>" class="btn btn-lg btn-info center" style="margin-top:5px ; margin-bottom:5px">Beli</a>
            </div>
          </div>
        </div>
      </div>
