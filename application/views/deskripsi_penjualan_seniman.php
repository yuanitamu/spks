...
<head>
  ...
  <title>Jual Beli-Sistem Pelelangan Karya Seni</title>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div>
              <a href="<?php echo base_url();?>penjualan_controller/delete_penjualan/<?php echo $key->id_barang?>" class="btn btn-lg btn-info center" style="margin-top:5px ; margin-bottom:5px">Delete</a>
            </div>
          </div>
          <?php }?>
        </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          <?php echo form_open_multipart("penjualan_controller/edit_penjualan"); ?>
