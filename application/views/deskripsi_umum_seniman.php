...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
 ...
 <section id="deskripsi" class="home-section text-center bg-gray">
  <div class="container">
    ...
    <div class="container">
      <div>
        <img class="img-responsive img-thumbnail" src="<?php echo base_url();?>/aset/img/gallery/<?php echo $key->foto ?>" alt="<?php echo $key->foto;?>"/>
      </div>
      <br>
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div>
              <a href="<?php echo base_url();?>gallery_controller/delete_gallery/<?php echo $key->id_barang?>" class="btn btn-lg btn-info center" style="margin-top:5px ; margin-bottom:5px">Delete</a>
            </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          <?php echo form_open_multipart("gallery_controller/edit_gallery"); ?>
