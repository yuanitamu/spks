...
<head>
  ...
  <title>Manajemen User-Sistem Pelelangan Karya Seni</title>
  ...
  <section id="deskripsi" class="home-section text-center bg-gray">
    ...
    if($item==null){
      ...
      foreach ($item as $key) {
        ...
        echo "<td>";
        ?>
        <form method="post" action="<?php echo base_url()?>manajemen_user_controller/delete_member/<?php echo $key->id_user;?>">
          <div class="form-group">
          <button class="btn btn-danger" type="submit" class="ion-ios7-trash">Hapus</button>
          </div>
        </form>
