           ...
           <?php foreach ($item as $key) {
            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
              <a href="<?php echo base_url();?>pelelangan_controller/deskripsi/<?php echo $key->id_barang;?>"><img width="200px" height="200px" 
                ...
                <p class="subtitle"><?php echo "Batas Pelelangan: ".$sisa."hari lagi";?></p>
              </div>
              <?php }}}?>
            </div>
        </section>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <?php echo form_open_multipart("pelelangan_controller/tambah_pelelangan"); ?>
                ...
                <div class="control-group">
                  <label class="control-label" for="inputBatas">Batas Pelelangan</label>
                  <div class="controls">
                    <input type="date" name="batas_pelelangan" id="inputBatas" placeholder="Batas Pelelangan" required>
                  </div>
                </div>
                <div class="control-group">
                <label class="control-label" for="inputBatas">Pilih Foto</label>
                  <div class="controls">
                    <div class="span6">
