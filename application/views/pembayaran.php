    ...
    <thead>
      <tr>
        ...
        foreach ($item as $key) {
         ...
         echo "</td>";
         echo "<td>";
         if(($this->session->userdata('id_user')==$key->id_pembeli)&&($key->bukti_pembayaran==null)){?>
         <div class="form-group">
          ...
          <button id="submit" class="btn btn-primary" type="submit">Submit Bukti</button>
          <?php echo form_close();?> 
        </div>
        <?php }}
        echo "</td>";
