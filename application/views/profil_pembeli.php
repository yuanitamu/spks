...
<head>
  ...
  <title>Profil=Sistem Pelalangan Karya Seni</title>
      ...
      <div class="wow bounceInUp" data-wow-delay="0.5s">
        <div class="team boxed-grey">
          <div class="inner">
            ...
            <div class="avatar"><img src="<?php echo base_url()?>aset/img/user/<?php echo $this->session->userdata('foto');?>"  width="300px"height="300px"alt="<?php echo $this->session->userdata('foto');?>" class="img-responsive img-circle" /></div>
